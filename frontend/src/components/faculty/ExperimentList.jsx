...
function ExperimentList({ lab, onSelectExperiment, onExperimentsLoaded }) {
  ...
  const fetchExperiments = async () => {
    ...
    setExperiments(data);
    if (onExperimentsLoaded) {
      onExperimentsLoaded(data);
    }
  };
    ...
    <div className='experiment-list card'>
      ...
      <form className='form' onSubmit={handleSubmit}>
        ...
        <button type="submit" disabled={loading}>
          {loading ? 'Adding Experiment...' : 'Add Experiment'}
        </button>
      </form>
